...
public class hdd_g500 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdd_g500);

        button_save = (Button) findViewById(R.id.Save_G5_hdd);
        rG = (RadioGroup) findViewById(R.id.hdd_RadioGrp);
        tv = (TextView) findViewById(R.id.hddNameG500);
